<template>
    <div class="body-login">
        <div id="wrapper">
            <form @submit.prevent="register" id="form-login" style="margin: 0 auto;">
                <h1 class="form-heading">Đăng Ký</h1>
                <div class="form-group">
                    <i style="margin-top: 8px;" class="fa fa-user"></i>
                    <input type="text" class="form-input" placeholder="Tên đăng ký" v-model="registerForm.username"
                        required>
                </div>
                <div class="form-group">
                ...
                <button type="submit" value="" class="form-submit">Đăng ký</button>
                <h5 style="margin-top: 30px;"><router-link to="/login">Bạn đã có tài khoản? Đăng nhập</router-link></h5>
            </form>
        </div>
    </div>
</template>
